...
if __name__ == "__main__":
    ...
    **NOTE: Minerals must be written just as they are below to set the "min_name" variable properly
    ...
    SpecDict = {"Mass" : x.transpose(), "Amplitude" : y.transpose()}
    SpecFrame = pd.DataFrame([SpecDict], columns = ["Mass", "Amplitude"])
    #print(SpecFrame)
    spec_save = str(min_name) + ".csv"
